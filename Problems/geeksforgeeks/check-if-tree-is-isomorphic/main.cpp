...
bool isIsomorphic(Node *root1, Node *root2)
{
    ...
    if(root1->data != root2->data)
        return false;
    bool res = isIsomorphic(root1->left, root2->left) && isIsomorphic(root1->right, root2->right);

    if(!res)
        res = isIsomorphic(root1->left, root2->right) && isIsomorphic(root1->right, root2->left);
